...
alias commands='bat $HOME/Tools/Commands'
alias c='cmatrix'
alias root='sudo su -'
...
alias fz='fzf -e --preview="bat --theme=Dracula --color=always {}" --color=fg:255,bg:000,hl:140,fg+:140,bg+:000,hl+:140 --color info:183,prompt:110,spinner:107,pointer:167,marker:215'
#-e --preview="bat --theme=Dracula --color=always {}"
...
#---------------- Docker Commands ---------------#
alias ubuntu='docker start ubuntu && docker exec -it ubuntu /bin/bash'
